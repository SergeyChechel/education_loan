    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var msg = btn.parentNode.nextElementSibling;
...
/*#__PURE__*/
function () {
  function Download(triggerSelector) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "checkMailInputs",
    value: function checkMailInputs(event) {
      var reg = /[а-яА-ЯёЁ]/g;
    ...
    value: function init() {
      ...
      new _mask__WEBPACK_IMPORTED_MODULE_7__["default"]('[name="phone"]').init();
      this.forms.forEach(function (item) {
        item.querySelector('input[name="email"]').addEventListener('input', function (e) {
          _this.checkMailInputs(e);
        });
...
function () {
  ...
  _createClass(Mask, [{
    ...
    value: function createMask(event) {
      ...
      target.value = matrix.replace(/./g, function (sym) {
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          if (_this.path && _this.path !== btn.getAttribute('data-url')) {
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedEl = this.activeBtn.closest('.module__video-item').nextElementSibling;
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindTriggers",
    value: function bindTriggers(trigger, n) {
      var _this2 = this;
      ...
      trigger.forEach(function (el) {
        el.addEventListener('click', function (e) {
          ...
          if (e.target.tagName == el.tagName || e.target.tagName == el.children[0].tagName || e.target.tagName == el.children[0].children[0].tagName) {
            _this2.plusSlides(n);
          }
        });
      });
